...
PROVIDERS: dict[str, dict] = {
    "openrouter": {
        ...
        "models": {
            ...
            "google/gemini-2.0-flash-001": {"label": "Gemini 2.0 Flash（快速）", "json_mode": True},
    ...
    "dashscope": {
        ...
        "models": {
            "qwen-max": {"label": "Qwen Max", "json_mode": True},
            "qwen-plus": {"label": "Qwen Plus", "json_mode": True},
            "qwen-turbo": {"label": "Qwen Turbo", "json_mode": True},
            "qwen-long": {"label": "Qwen Long", "json_mode": False},
            "qwen3-235b-a22b": {"label": "Qwen3 235B（推荐）", "json_mode": True},
        },
    },
    "zhipu": {
        "label": "Zhipu / 智谱（官方）",
        ...
        "models": {
            "glm-4-plus": {"label": "GLM-4 Plus（推荐，JSON mode 最佳）", "json_mode": True},
            "glm-4.5": {"label": "GLM 4.5（有已知 bug）", "json_mode": False},
            "glm-4.5-air": {"label": "GLM 4.5 Air", "json_mode": True},
            "glm-4-air": {"label": "GLM 4 Air", "json_mode": True},
        },
    },
    "moonshot": {
        ...
        "models": {
            "moonshot-v1-8k": {"label": "Moonshot 8K", "json_mode": False},
            "moonshot-v1-32k": {"label": "Moonshot 32K", "json_mode": False},
            "moonshot-v1-128k": {"label": "Moonshot 128K", "json_mode": False},
            "kimi-k2-turbo-preview": {"label": "Kimi K2 Turbo Preview（推荐）", "json_mode": True},
        },
    },
    "deepseek": {
        "label": "DeepSeek（官方）",
        ...
        "models": {
            "deepseek-chat": {"label": "DeepSeek Chat（推荐）", "json_mode": True},
            "deepseek-reasoner": {"label": "DeepSeek Reasoner", "json_mode": False},
        },
    },
}

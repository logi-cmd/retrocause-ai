...
1. turn the worker-result dry-run into a persisted result snapshot only after durable worker-owned event writes, auth, quota, vault, and idempotent commit checks exist

...
1. design the next graph review workflow for comparing evidence and challenges across runs
2. plan real auth/tenant, credential-vault, quota-ledger, and worker boundaries before any live adapter execution

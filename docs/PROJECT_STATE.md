...
1. add durable event/status vocabulary for run history before connecting stores
2. prepare the first live-provider adapter candidate behind explicit auth, quota, and dry-run gates
3. design the next graph review workflow for comparing evidence and challenges across runs

...
1. make the composed execution-readiness gate the handoff into future provider/worker execution paths before enabling real provider calls, credential reads, quota reservations, worker leases, snapshot persistence, or worker result commits

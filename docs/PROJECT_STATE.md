...
1. define the first worker/executor contract behind preview-only queue jobs without adding provider credentials
2. add route-step detail visibility for queued preview jobs before any provider execution

...
1. wire workspace access-gate decisions into future provider/worker execution paths before enabling real provider calls, credential reads, quota reservations, or worker result commits

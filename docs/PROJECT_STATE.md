...
1. turn the result-snapshot readiness gate into a persisted result snapshot only after durable worker-owned event writes, auth, quota, vault, and idempotent commit checks exist

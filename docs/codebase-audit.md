...
1. Move provider preflight route orchestration into a focused route module, mirroring `retrocause/api/evidence_routes.py` and `retrocause/api/run_routes.py`.
